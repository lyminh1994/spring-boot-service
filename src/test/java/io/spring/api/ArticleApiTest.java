...
public class ArticleApiTest extends TestWithCurrentUser {
    ...
    public void should_get_403_if_not_author_to_update_article() {
        ...
        Article article = new Article(title, description, body, Arrays.asList("java", "spring", "jpg"), anotherUser.getId());
    ...
    private Map<String, Object> prepareUpdateParam(final String title, final String body, final String description) {
        return ImmutableMap.of("article", ImmutableMap.of("title", title, "body", body, "description", description));
    }
}
