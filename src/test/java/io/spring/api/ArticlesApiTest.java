...
public class ArticlesApiTest extends TestWithCurrentUser {
    ...
    public void should_create_article_success() throws Exception {
        ...
        when(articleCommandService.createArticle(any(), any())).thenReturn(new Article(title, description, body, tagList, user.getId()));
    ...
    private Map<String, Object> prepareParam(final String title, final String description, final String body, final List<String> tagList) {
        return ImmutableMap.of("article", ImmutableMap.of("title", title, "description", description, "body", body, "tagList", tagList));
    }
}
