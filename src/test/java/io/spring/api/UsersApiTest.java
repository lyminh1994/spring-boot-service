...
public class UsersApiTest {
    ...
    public void should_show_error_for_duplicated_username() {
        ...
        when(userRepository.findByUsername(username)).thenReturn(Optional.of(new User(email, username, "123", "bio", "")));
    ...
    public void should_show_error_for_duplicated_email() {
        ...
        when(userRepository.findByEmail(email)).thenReturn(Optional.of(new User(email, username, "123", "bio", "")));
    ...
    public void should_login_success() {
        ...
        Map<String, Object> param = ImmutableMap.of("user", ImmutableMap.of("email", email, "password", password));
    ...
    public void should_fail_login_with_wrong_password() {
        ...
        Map<String, Object> param = ImmutableMap.of("user", ImmutableMap.of("email", email, "password", "123123"));
